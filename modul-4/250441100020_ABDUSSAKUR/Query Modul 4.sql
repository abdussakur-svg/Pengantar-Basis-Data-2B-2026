...
WHERE bidang_keahlian IN ('Basis Data','Pemrograman');



SELECT nama_mahasiswa, id_mata_kuliah FROM mahasiswa m 
LEFT JOIN krs k 
...
SELECT nama_mahasiswa, nama_mk, sks FROM mahasiswa m
...
SELECT nama_mahasiswa, angkatan, nama_mk, nama_dosen FROM mahasiswa m
JOIN krs k ON m.id_mahasiswa = k.id_mahasiswa
JOIN mata_kuliah mk ON k.id_mata_kuliah = mk.id_mata_kuliah
